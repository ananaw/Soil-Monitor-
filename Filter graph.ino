...
float temperatureC;
float temperatureF;
const float alpha = 0.2; // const means value can't be changed, read only
...
void loop() {
  for(int i=0; i<=10; i++){
    ...
    // print out the voltage
    Serial.print(voltage); Serial.print(",");//Serial.print(" volts"); 
    //Serial.print("; Filtered "); 
    Serial.print(y); Serial.print(",");Serial.println();
    /* 
